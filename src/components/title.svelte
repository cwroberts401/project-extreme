<svelte:head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Michroma&display=swap" rel="stylesheet">
</svelte:head>

<script>
import imm1 from '$lib/assets/flag-blu.png';
import imm2 from '$lib/assets/project extreme logo.png';
</script>
